...
<body class="bg-surface font-sans text-slate-800 antialiased">
    ...
    {{-- Lightbox للمعرض --}}
    <div id="lightbox" class="lightbox" role="dialog" aria-modal="true" aria-label="عرض الصورة" aria-hidden="true">
        <button type="button" data-lightbox-close aria-label="إغلاق"
                class="absolute top-5 end-5 flex h-11 w-11 items-center justify-center rounded-full bg-white/10 text-white transition hover:bg-white/20 focus:outline-none focus:ring-2 focus:ring-white/40">
            <svg class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" aria-hidden="true"><path stroke-linecap="round" stroke-linejoin="round" d="M6 18 18 6M6 6l12 12"/></svg>
        </button>
    ...
    <button id="back-to-top" type="button" aria-label="العودة للأعلى"
            class="fixed bottom-5 start-5 z-50 flex h-12 w-12 items-center justify-center rounded-full bg-brand text-white shadow-2xl transition hover:bg-brand-dark focus:outline-none focus:ring-2 focus:ring-brand/40 focus:ring-offset-2">
